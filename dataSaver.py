...
# Function to write questions and answers to a CSV file
def write_to_csv(file_path, qa_pairs):
...
file_path = 'interior_design_qa.csv'
qa_pairs = generate_questions_and_answers()
write_to_csv(file_path, qa_pairs)
print(f"Questions and answers have been saved to {file_path}")
